...
class  Periodistas(models.Model):
    id_Periodista = models.IntegerField(primary_key=True,verbose_name='Id Periodista',null = True)
    nombre = models.CharField(max_length=15,verbose_name='nombre',null = True)
    ...
    tipo_Periodista = models.CharField(max_length=60,verbose_name='Tipo Periodista',null = True)
